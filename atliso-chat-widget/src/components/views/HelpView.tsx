...
export function HelpView() {
  ...
  if (activeArticle) {
    return (
      <div className="flex flex-col h-full bg-white">
        ...
        <div style={{ padding: '16px' }} className="p-6 overflow-y-auto atliso-scrollbar">
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50/50">
      ...
      {/* Collections List */}
      <div style={{ cursor: 'pointer', paddingLeft: '14px', paddingRight: '14px', paddingTop: '6px', }} className="flex-1 bg-white overflow-y-auto atliso-scrollbar">
