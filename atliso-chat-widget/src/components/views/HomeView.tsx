  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Quick Actions Container (Enterprise Apps/Tools) */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            ...
            onClick={() => {
              ...
              setTimeout(() => {
                import('@/stores/chatStore').then(({ useChatStore }) => {
                  useChatStore.getState().sendMessage('I want to book a demo');
                });
              }, 100);
            }}
            style={{
          ...
          >
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: 600, color: '#0F172A' }}>Book a Demo</div>
              <div style={{ fontSize: '12px', color: '#64748B', marginTop: '4px' }}>See it in action</div>
            </div>
          </button>
          ...
          <button
            onClick={() => {
              ...
              setTimeout(() => {
                import('@/stores/chatStore').then(({ useChatStore }) => {
                  useChatStore.getState().sendMessage('I want to talk to sales');
                });
              }, 100);
            }}
            style={{
          ...
          >
            ...
            <div>
              <div style={{ fontSize: '14px', fontWeight: 600, color: '#0F172A' }}>Talk to Sales</div>
              <div style={{ fontSize: '12px', color: '#64748B', marginTop: '4px' }}>Get a custom quote</div>
            </div>
          </button>
        </div>
        style={{
